...
// @wdk-core/abstractedAccountTransfer-request-config.paymasterToken
const encoding27_0 = c.frame(encoding26)
...
const encoding27 = {
  preencode (state, m) {
    ...
    if (m.paymasterToken) encoding27_0.preencode(state, m.paymasterToken)
  ...
  encode (state, m) {
    ...
    if (m.paymasterToken) encoding27_0.encode(state, m.paymasterToken)
  ...
  decode (state) {
    ...
    return {
      paymasterToken: (flags & 1) !== 0 ? encoding27_0.decode(state) : null,
...
// @wdk-core/abstractedAccountTransfer-request.options
const encoding28_2 = c.frame(encoding25)
// @wdk-core/abstractedAccountTransfer-request.config
const encoding28_3 = c.frame(encoding27)
...
const encoding28 = {
  preencode (state, m) {
    ...
    if (m.config) encoding28_3.preencode(state, m.config)
  },
  encode (state, m) {
    ...
    if (m.config) encoding28_3.encode(state, m.config)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.uint.decode(state)
    ...
    return {
      ...
      accountIndex: r1,
      options: r2,
      config: (flags & 1) !== 0 ? encoding28_3.decode(state) : null
    }
  }
}
...
const encoding37 = encoding26

// @wdk-core/abstractedAccountQuoteTransfer-request-config.paymasterToken
const encoding38_0 = c.frame(encoding37)
...
const encoding38 = {
  preencode (state, m) {
    ...
    if (m.paymasterToken) encoding38_0.preencode(state, m.paymasterToken)
  },
  encode (state, m) {
    const flags = m.paymasterToken ? 1 : 0
    ...
    if (m.paymasterToken) encoding38_0.encode(state, m.paymasterToken)
  },
  decode (state) {
    const flags = c.uint.decode(state)

    return {
      paymasterToken: (flags & 1) !== 0 ? encoding38_0.decode(state) : null
    }
  }
}

// @wdk-core/abstractedAccountQuoteTransfer-request.options
const encoding39_4 = c.frame(encoding36)
// @wdk-core/abstractedAccountQuoteTransfer-request.config
const encoding39_5 = c.frame(encoding38)
...
const encoding39 = {
  preencode (state, m) {
    ...
    if (m.accountIndex) c.uint.preencode(state, m.accountIndex)
    if (m.address) c.string.preencode(state, m.address)
    encoding39_4.preencode(state, m.options)
    if (m.config) encoding39_5.preencode(state, m.config)
  },
  encode (state, m) {
    const flags =
      (m.accountIndex ? 1 : 0) |
    ...
    if (m.accountIndex) c.uint.encode(state, m.accountIndex)
    if (m.address) c.string.encode(state, m.address)
    encoding39_4.encode(state, m.options)
    if (m.config) encoding39_5.encode(state, m.config)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      accountIndex: (flags & 1) !== 0 ? c.uint.decode(state) : 0,
      address: (flags & 2) !== 0 ? c.string.decode(state) : null,
      options: encoding39_4.decode(state),
      config: (flags & 4) !== 0 ? encoding39_5.decode(state) : null
    }
  }
}

// @wdk-core/abstractedAccountQuoteTransfer-response
const encoding40 = encoding15
...
const encoding49 = encoding47

// @wdk-core/disposeWdk-request
const encoding50 = encoding47

// @wdk-core/disposeWdkReadOnly-request
const encoding51 = encoding47
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@wdk-core/getAbstractedAddress-request': return encoding19
    case '@wdk-core/getAbstractedAddress-response': return encoding20
    case '@wdk-core/getAbstractedAddressBalance-request': return encoding21
    case '@wdk-core/getAbstractedAddressBalance-response': return encoding22
    case '@wdk-core/getAbstractedAddressTokenBalance-request': return encoding23
    case '@wdk-core/getAbstractedAddressTokenBalance-response': return encoding24
    case '@wdk-core/abstractedAccountTransfer-request-options': return encoding25
    case '@wdk-core/abstractedAccountTransfer-request-config-paymasterToken': return encoding26
    case '@wdk-core/abstractedAccountTransfer-request-config': return encoding27
    case '@wdk-core/abstractedAccountTransfer-request': return encoding28
    case '@wdk-core/abstractedAccountTransfer-response': return encoding29
    case '@wdk-core/getApproveTransaction-request': return encoding30
    case '@wdk-core/getApproveTransaction-response': return encoding31
    case '@wdk-core/abstractedSendTransaction-request-config-paymasterToken': return encoding32
    case '@wdk-core/abstractedSendTransaction-request-config': return encoding33
    case '@wdk-core/abstractedSendTransaction-request': return encoding34
    case '@wdk-core/abstractedSendTransaction-response': return encoding35
    case '@wdk-core/abstractedAccountQuoteTransfer-request-options': return encoding36
    case '@wdk-core/abstractedAccountQuoteTransfer-request-config-paymasterToken': return encoding37
    case '@wdk-core/abstractedAccountQuoteTransfer-request-config': return encoding38
    case '@wdk-core/abstractedAccountQuoteTransfer-request': return encoding39
    case '@wdk-core/abstractedAccountQuoteTransfer-response': return encoding40
    case '@wdk-core/getTransactionReceipt-request': return encoding41
    case '@wdk-core/getTransactionReceipt-response': return encoding42
    case '@wdk-core/generateAndEncrypt-request': return encoding43
    case '@wdk-core/generateAndEncrypt-response': return encoding44
    case '@wdk-core/decrypt-request': return encoding45
    case '@wdk-core/decrypt-response': return encoding46
    case '@wdk-core/generateSeed-request': return encoding47
    case '@wdk-core/generateSeed-response': return encoding48
    case '@wdk-core/dispose-request': return encoding49
    case '@wdk-core/disposeWdk-request': return encoding50
    case '@wdk-core/disposeWdkReadOnly-request': return encoding51
