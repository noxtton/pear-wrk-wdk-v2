...
// @wdk-core/abstractedSendTransaction-request-config.paymasterToken
const encoding32_0 = c.frame(encoding30)
...
// @wdk-core/abstractedSendTransaction-request.options
const encoding33_2 = c.frame(encoding31)
// @wdk-core/abstractedSendTransaction-request.config
...
const encoding33 = {
  preencode (state, m) {
    c.string.preencode(state, m.network)
    c.uint.preencode(state, m.accountIndex)
    encoding33_2.preencode(state, m.options)
    state.end++ // max flag is 1 so always one byte
  ...
  encode (state, m) {
    ...
    c.string.encode(state, m.network)
    c.uint.encode(state, m.accountIndex)
    encoding33_2.encode(state, m.options)
    c.uint.encode(state, flags)
  ...
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.uint.decode(state)
    const r2 = encoding33_2.decode(state)
    const flags = c.uint.decode(state)
...
const encoding52 = {
  preencode (state, m) {
    ...
    if (version >= 2 && m.data) c.string.preencode(state, m.data)
  },
  encode (state, m) {
    const flags = (version >= 2 && m.data) ? 1 : 0

    c.string.encode(state, m.to)
    c.string.encode(state, m.value)
    c.uint.encode(state, flags)

    if (version >= 2 && m.data) c.string.encode(state, m.data)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      to: r0,
      value: r1,
      data: (version >= 2 && (flags & 1) !== 0) ? c.string.decode(state) : null
    }
  }
}
...
const encoding53 = {
  preencode (state, m) {
    ...
    if (version >= 2 && m.paymasterToken) encoding53_0.preencode(state, m.paymasterToken)
  },
  encode (state, m) {
    const flags = (version >= 2 && m.paymasterToken) ? 1 : 0

    c.uint.encode(state, flags)

    if (version >= 2 && m.paymasterToken) encoding53_0.encode(state, m.paymasterToken)
  },
  decode (state) {
    const flags = c.uint.decode(state)

    return {
      paymasterToken: (version >= 2 && (flags & 1) !== 0) ? encoding53_0.decode(state) : null
    }
  }
}

// @wdk-core/abstractedQuoteSendTransaction-request.options
const encoding54_2 = c.frame(encoding52)
// @wdk-core/abstractedQuoteSendTransaction-request.config
const encoding54_3 = c.frame(encoding53)
...
const encoding54 = {
  preencode (state, m) {
    ...
    if (version >= 2 && m.config) encoding54_3.preencode(state, m.config)
  },
  encode (state, m) {
    const flags = (version >= 2 && m.config) ? 1 : 0
    ...
    if (version >= 2 && m.config) encoding54_3.encode(state, m.config)
  },
  decode (state) {
    const r0 = c.string.decode(state)
    const r1 = c.uint.decode(state)
    ...
    return {
      ...
      accountIndex: r1,
      options: r2,
      config: (version >= 2 && (flags & 1) !== 0) ? encoding54_3.decode(state) : null
    }
  }
}
...
function getEncoding (name) {
  switch (name) {
    ...
    case '@wdk-core/abstractedSendTransaction-request-options': return encoding31
    ...
    case '@wdk-core/getMaxSpendable-request': return encoding49
    case '@wdk-core/getMaxSpendable-response': return encoding50
    case '@wdk-core/abstractedQuoteSendTransaction-request-config-paymasterToken': return encoding51
    case '@wdk-core/abstractedQuoteSendTransaction-request-options': return encoding52
    case '@wdk-core/abstractedQuoteSendTransaction-request-config': return encoding53
    case '@wdk-core/abstractedQuoteSendTransaction-request': return encoding54
    case '@wdk-core/abstractedQuoteSendTransaction-response': return encoding55
